...
api_set_setup()
{
    ...
    sudo apt-get -y install chromium cockpit cockpit-machines dos2unix git git-lfs gnome keepassxc neofetch openssh-server python3 python3-pip python3-venv rsync sudo tmux vim virt-manager wl-clipboard zsh
