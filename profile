...
api_set_setup()
{
    ...
    sudo apt-get -y install curl dos2unix htop git keepassxc nano neofetch openssh-server python3 python3-pip python3-venv rsync sudo tmux vim virt-manager zsh
...
api_set_setup_all()
{
    ...
    ssh -tt HQDEBDELL02 " . ~/.profile; api_set_setup"
