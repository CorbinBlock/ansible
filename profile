...
function config() {
    USER=cblock
    DOMAIN_URL=devenvzone.com
    SEARCH_URL=duckduckgo.com
    JAVA_WIN=/c/Users/$USER/docs/eclipse/java_dev/bin/
    JAVA_LINUX=/home/$USER/docs/eclipse/java_dev/bin/
	export DATABASE='l2=0g,yHj0BJEix##6C\'
    ...
    export PATH="/opt/maven/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/c/Windows/System32/:/c/Windows/System32/WindowsPowershell/v1.0/:/c/Windows/:/home/$USER/.local/bin:/home/$USER/:/c/Windows/System32/OpenSSH/:/c/Program Files (x86)/Microsoft Office/root/Office16/:/home/$USER/.local/bin/:"
    export PS1="\\s-\\v$ "
...
function rsync_git_win {
    rsync -avP prod:~/.local/share/docs/ /c/Users/cbloc/.local/share/docs/
}
...
function ssh_tunnel() {
    ssh -p 50100 -L 3390:KVM_WIN:3389 -L 5902:PROD:5902 -L 8081:KVM_DEB_TEST:8080 -L 9091:KVM_DEB_TEST:9090 cblock@devenvzone.com
}
...
function vm_install_debian() {
    vm_list
    sudo virt-install --name KVMDEBPROD01 --description 'debian' --ram 2048 --vcpus 1 --disk path=/home/cblock/.local/state/kvm/debian-11.5.0-amd64-netinst_20221112.qcow2,size=120 --os-variant debian11 --network bridge=virbr0 --cdrom /home/cblock/.local/state/kvm/debian-11.5.0-amd64-netinst.iso --noautoconsole
}

function vm_install_windows() {
    vm_list
    sudo virt-install --name KVMWINPROD01 --description 'Windows' --ram 16384 --vcpus 4 --disk path=/home/cblock/.local/state/kvm/Win10_21H2_English_x64_20221112.qcow2,size=300 --os-variant win10 --network bridge=virbr0 --cdrom /home/cblock/.local/state/kvm/Win10_21H2_English_x64.iso --noautoconsole
}
